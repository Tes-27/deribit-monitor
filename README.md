...
- หมวด **Deribit · Option** ใน dropdown: option ที่ถือ position/มี order ขึ้นให้เอง + รายการ "➕ เลือก option…" (expiry → strike → Call/Put) เปิดกราฟ option ตัวไหนก็ได้ และจำตัวที่เปิดล่าสุดไว้
